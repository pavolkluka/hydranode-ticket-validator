    ...
    loadTranslations() {
        this.translations = {
            en: {
                ...
                scannerReady: 'Position QR code within frame',
                tokenInvalid: 'Invalid API token format',
            ...
            sk: {
                ...
                logout: 'Odhlásiť',
                scanApiToken: 'Skenovať QR kód API tokenu',
                scannerReady: 'Umiestnite QR kód do rámčeka',
                tokenInvalid: 'Neplatný formát API tokenu',
                tokenRequired: 'API token je povinný',
                authenticationFailed: 'Overenie zlyhalo',
                networkError: 'Chyba sieťového pripojenia',
            ...
            cz: {
                ...
                logout: 'Odhlásit',
                scanApiToken: 'Skenovat QR kód API tokenu',
                scannerReady: 'Umístěte QR kód do rámečku',
                tokenInvalid: 'Neplatný formát API tokenu',
                tokenRequired: 'API token je vyžadován',
                authenticationFailed: 'Ověření selhalo',
                networkError: 'Chyba síťového připojení',
            ...
            es: {
                ...
                scanApiToken: 'Escanear código QR del token API',
                scannerReady: 'Posicione el código QR dentro del marco',
                tokenInvalid: 'Formato de token API inválido',
                tokenRequired: 'Se requiere token API',
